...
.. py:class:: S3.Client
  ...
  *   :py:meth:`~S3.Client.select_object_content`
  ...
  *   :py:meth:`~S3.Client.upload_part_copy`
  ...
  .. py:method:: select_object_content(**kwargs)
    ...
    **Request Syntax** 
    ...
    :type SelectRequest: dict
    :param SelectRequest: **[REQUIRED]** 
